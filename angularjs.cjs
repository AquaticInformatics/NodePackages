...
// projects/dynamic-analytics-core/src/angularjs/public-api.ts
var public_api_exports = {};
__export(public_api_exports, {
  DYNAMIC_ANALYTICS_ANGULARJS_MODULE_NAME: () => DYNAMIC_ANALYTICS_ANGULARJS_MODULE_NAME,
  DYNAMIC_ANALYTICS_ANGULARJS_SERVICE_NAME: () => DYNAMIC_ANALYTICS_ANGULARJS_SERVICE_NAME,
  registerDynamicAnalyticsAngularJsModule: () => registerDynamicAnalyticsAngularJsModule
});
...
// projects/dynamic-analytics-core/src/angularjs/dynamic-analytics-angularjs.ts
var DYNAMIC_ANALYTICS_ANGULARJS_MODULE_NAME = "dynamicAnalytics";
var DYNAMIC_ANALYTICS_ANGULARJS_SERVICE_NAME = "dynamicAnalyticsService";
function registerDynamicAnalyticsAngularJsModule(angularInstance, options = {}) {
  angularInstance.module(DYNAMIC_ANALYTICS_ANGULARJS_MODULE_NAME, []).service(DYNAMIC_ANALYTICS_ANGULARJS_SERVICE_NAME, ["$rootScope", function($rootScope) {
    return new DynamicAnalyticsCore({
      runInZone: (fn) => $rootScope.$applyAsync(fn),
      ...options
    });
  }]);
  return DYNAMIC_ANALYTICS_ANGULARJS_MODULE_NAME;
}
// Annotate the CommonJS export names for ESM import in node:
0 && (module.exports = {
  DYNAMIC_ANALYTICS_ANGULARJS_MODULE_NAME,
  DYNAMIC_ANALYTICS_ANGULARJS_SERVICE_NAME,
  registerDynamicAnalyticsAngularJsModule
});
//# sourceMappingURL=angularjs.cjs.map