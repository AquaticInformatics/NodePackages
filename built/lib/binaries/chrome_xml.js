...
class ChromeXml extends config_source_1.XmlConfigSource {
    ...
    getLatestChromeDriverVersion() {
        const latestReleaseUrl = 'https://googlechromelabs.github.io/chrome-for-testing/last-known-good-versions-with-downloads.json';
        return http_utils_1.requestBody(latestReleaseUrl).then(body => {
